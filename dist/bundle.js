...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar handleError = exports.handleError = function handleError(err) {\n  return console.log(err);\n};\n\n//# sourceURL=webpack:///./src/base.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _base = __webpack_require__(/*! ../../base */ \"./src/base.js\");\n\nvar _view = __webpack_require__(/*! ./view */ \"./src/components/cart/view.js\");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar CartComponent = function () {\n    function CartComponent() {\n        _classCallCheck(this, CartComponent);\n\n        try {\n            this.setupEventListeners();\n\n            this.calculate();\n        } catch (err) {\n            (0, _base.handleError)(err);\n        }\n    }\n\n    _createClass(CartComponent, [{\n        key: \"setupEventListeners\",\n        value: function setupEventListeners() {\n            var _this = this;\n\n            try {\n\n                // remove item row from cart\n                _view.elements.cartItems.addEventListener(\"click\", function (e) {\n                    _this.removeItem(e);\n                });\n            } catch (err) {\n                (0, _base.handleError)(err);\n            }\n        }\n    }, {\n        key: \"removeItem\",\n        value: function removeItem(e) {\n            var item = e.target.closest(\".cart__item-controls-remove\").closest(\".cart__item\");\n            if (item) {\n                item.parentNode.removeChild(item);\n            }\n        }\n    }, {\n        key: \"getItems\",\n        value: function getItems() {\n            var cartItems = Array.from(document.querySelectorAll(\".cart__item\")).map(function (item) {\n                var name = item.querySelector(\".cart__item-name\").textContent;\n                var price = parseInt(item.querySelector(\".cart__item-price\").textContent.split(\".\")[0]);\n                var count = parseInt(item.querySelector(\".cart__item-controls-count\").textContent);\n                return { name: name, price: price, count: count };\n            });\n            return cartItems;\n        }\n    }, {\n        key: \"calculate\",\n        value: function calculate() {\n            try {\n                var items = this.getItems();\n\n                var itemsSubTotal = 0;\n                items.forEach(function (item) {\n                    var itemValue = parseInt(item.count * item.price);\n                    itemsSubTotal += itemValue;\n                });\n\n                _view.elements.subTotal.textContent = this.format(itemsSubTotal);\n                _view.elements.deliveryFee.textContent = this.format(5);\n\n                var total = parseInt(_view.elements.subTotal.textContent) + parseInt(_view.elements.deliveryFee.textContent);\n                _view.elements.total.textContent = this.format(total);\n            } catch (err) {\n                (0, _base.handleError)(err);\n            }\n        }\n    }, {\n        key: \"format\",\n        value: function format(val) {\n            return val + \".00 EGP\";\n        }\n    }]);\n\n    return CartComponent;\n}();\n\nexports.default = CartComponent;\n\n//# sourceURL=webpack:///./src/components/cart/index.js?");

/***/ }),

/***/ "./src/components/cart/view.js":
/*!*************************************!*\
  !*** ./src/components/cart/view.js ***!
  \*************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _base = __webpack_require__(/*! ../../base */ \"./src/base.js\");\n\nvar _model = __webpack_require__(/*! ./model */ \"./src/components/location-selection/model.js\");\n\nvar _model2 = _interopRequireDefault(_model);\n\nvar _view = __webpack_require__(/*! ./view */ \"./src/components/location-selection/view.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar LocationSelectionComponent = function () {\n    function LocationSelectionComponent() {\n        _classCallCheck(this, LocationSelectionComponent);\n\n        this.setupEventListeners();\n    }\n\n    _createClass(LocationSelectionComponent, [{\n        key: \"init\",\n        value: function init() {\n            try {\n                this.model = new _model2.default();\n                this.view = new _view.LocationSelectionView();\n\n                this.view.render(this.model.cities);\n            } catch (err) {\n                (0, _base.handleError)(err);\n            }\n        }\n    }, {\n        key: \"setupEventListeners\",\n        value: function setupEventListeners() {\n            try {\n\n                // initialize location selection componenet\n                window.addEventListener(\"load\", this.init);\n\n                _view.elements.wrapper.addEventListener(\"click\", function (e) {\n\n                    var locationSelection = e.target.closest(\".location-selection\");\n                    var btn = locationSelection.querySelector(\".location-selection__btn\");\n                    var box = locationSelection.querySelector(\".location-selection__box\");\n                    var value = locationSelection.querySelector(\".location-selection__value\");\n\n                    // toggle header location selection\n                    if (e.target.matches(\".location-selection__btn, .location-selection__btn *\")) {\n                        btn.classList.toggle(\"location-selection__btn--open\");\n                        box.classList.toggle(\"location-selection__box--open\");\n                    }\n\n                    // display selected location value\n                    else if (e.target.matches(\".location-selection__area, .location-selection__area *\")) {\n                            var area = e.target.textContent;\n                            value.textContent = area;\n\n                            btn.classList.toggle(\"location-selection__btn--open\");\n                            box.classList.toggle(\"location-selection__box--open\");\n                        }\n                });\n            } catch (err) {\n                (0, _base.handleError)(err);\n            }\n        }\n    }]);\n\n    return LocationSelectionComponent;\n}();\n\nexports.default = LocationSelectionComponent;\n\n//# sourceURL=webpack:///./src/components/location-selection/index.js?");

/***/ }),

/***/ "./src/components/location-selection/model.js":
/*!****************************************************!*\
  !*** ./src/components/location-selection/model.js ***!
  \****************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _country = __webpack_require__(/*! ../../core/entities/country */ \"./src/core/entities/country.js\");\n\nvar _country2 = _interopRequireDefault(_country);\n\nvar _city = __webpack_require__(/*! ../../core/entities/city */ \"./src/core/entities/city.js\");\n\nvar _city2 = _interopRequireDefault(_city);\n\nvar _area = __webpack_require__(/*! ../../core/entities/area */ \"./src/core/entities/area.js\");\n\nvar _area2 = _interopRequireDefault(_area);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar LocationSelectionModel = function () {\n    function LocationSelectionModel() {\n        _classCallCheck(this, LocationSelectionModel);\n\n        this.cities = this.getCitites();\n        this.selectedArea = null;\n    }\n\n    _createClass(LocationSelectionModel, [{\n        key: \"getCitites\",\n        value: function getCitites() {\n            return [new _city2.default(\"1\", \"Cairo\", new _country2.default(\"1\", \"Egypt\"), [new _area2.default(\"1\", \"Heliopolis\"), new _area2.default(\"2\", \"Zamalek\"), new _area2.default(\"3\", \"DownTown\"), new _area2.default(\"4\", \"Nasr City\"), new _area2.default(\"5\", \"Maadi\"), new _area2.default(\"6\", \"Shoubra\")]), new _city2.default(\"2\", \"Giza\", new _country2.default(\"1\", \"Egypt\"), [new _area2.default(\"1\", \"Mohandessien\"), new _area2.default(\"2\", \"Dokki\"), new _area2.default(\"3\", \"Giza Square\"), new _area2.default(\"4\", \"Haram\"), new _area2.default(\"5\", \"6th October\")]), new _city2.default(\"3\", \"Alexandria\", new _country2.default(\"1\", \"Egypt\"), [new _area2.default(\"1\", \"San Stephano\"), new _area2.default(\"2\", \"DownTown\"), new _area2.default(\"3\", \"Sidi Beshr\"), new _area2.default(\"4\", \"El Raml\")])];\n        }\n    }]);\n\n    return LocationSelectionModel;\n}();\n\nexports.default = LocationSelectionModel;\n\n//# sourceURL=webpack:///./src/components/location-selection/model.js?");

/***/ }),

/***/ "./src/components/location-selection/view.js":
/*!***************************************************!*\
  !*** ./src/components/location-selection/view.js ***!
  \***************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _base = __webpack_require__(/*! ../../base */ \"./src/base.js\");\n\nvar _view = __webpack_require__(/*! ./view */ \"./src/components/menu-item-modal/view.js\");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar ItemModalComponent = function () {\n    function ItemModalComponent() {\n        _classCallCheck(this, ItemModalComponent);\n\n        this.setupEventListeners();\n    }\n\n    _createClass(ItemModalComponent, [{\n        key: \"setupEventListeners\",\n        value: function setupEventListeners() {\n            var _this = this;\n\n            try {\n\n                // open modal\n                _view.elements.menuItemsWrapper.addEventListener(\"click\", function (e) {\n                    var item = e.target.closest(\".menu-item\");\n                    if (item) {\n                        _this.open();\n                        console.log(item.id);\n                    }\n                });\n\n                // close modal\n                Array.from(document.querySelectorAll(\".menu-item-modal__close, .add-order-btn\")).forEach(function (elm) {\n                    return elm.addEventListener(\"click\", _this.close);\n                });\n\n                // toggle item option\n                _view.elements.modalBody.addEventListener(\"click\", function (e) {\n                    _this.toggleItemOption(e);\n                });\n\n                // increment/decrement menu item count\n                Array.from(document.querySelectorAll(\".cart-controls\")).forEach(function (el) {\n                    return el.addEventListener(\"click\", function (e) {\n\n                        var op = e.target.closest(\".cart-controls__btn\").textContent;\n                        var countLabel = _view.elements.itemCount;\n                        var count = parseInt(countLabel.textContent);\n\n                        if (op === \"+\") {\n                            count++;\n                        } else {\n                            if (count > 1) count--;\n                        }\n\n                        countLabel.textContent = count;\n                    });\n                });\n            } catch (err) {\n                (0, _base.handleError)(err);\n            }\n        }\n    }, {\n        key: \"open\",\n        value: function open() {\n            _view.elements.modal.classList.remove(\"menu-item-modal--close\");\n            _view.elements.modal.classList.add(\"menu-item-modal--open\");\n        }\n    }, {\n        key: \"close\",\n        value: function close() {\n            _view.elements.modal.classList.remove(\"menu-item-modal--open\");\n            _view.elements.modal.classList.add(\"menu-item-modal--close\");\n        }\n    }, {\n        key: \"toggleItemOption\",\n        value: function toggleItemOption(e) {\n            var option = e.target.closest(\".dish-options\");\n            option.classList.toggle(\"dish-options--closed\");\n        }\n    }]);\n\n    return ItemModalComponent;\n}();\n\nexports.default = ItemModalComponent;\n\n//# sourceURL=webpack:///./src/components/menu-item-modal/index.js?");

/***/ }),

/***/ "./src/components/menu-item-modal/view.js":
/*!************************************************!*\
  !*** ./src/components/menu-item-modal/view.js ***!
  \************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _base = __webpack_require__(/*! ../../base */ \"./src/base.js\");\n\nvar _model = __webpack_require__(/*! ./model */ \"./src/components/restaurant-selection/model.js\");\n\nvar _model2 = _interopRequireDefault(_model);\n\nvar _view = __webpack_require__(/*! ./view */ \"./src/components/restaurant-selection/view.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar RestaurantSelectionComponent = function () {\n    function RestaurantSelectionComponent() {\n        _classCallCheck(this, RestaurantSelectionComponent);\n\n        this.setupEventListeners();\n    }\n\n    _createClass(RestaurantSelectionComponent, [{\n        key: \"init\",\n        value: function init() {\n            try {\n                this.model = new _model2.default();\n                this.view = new _view.RestaurantSelectionView();\n\n                this.view.render(this.model.restaurants);\n            } catch (err) {\n                (0, _base.handleError)(err);\n            }\n        }\n    }, {\n        key: \"setupEventListeners\",\n        value: function setupEventListeners() {\n            try {\n\n                // initialize restaurant selection componenet\n                window.addEventListener(\"load\", this.init);\n\n                _view.elements.wrapper.addEventListener(\"click\", function (e) {\n\n                    var restaurantSelection = e.target.closest(\".restaurant-selection\");\n                    var btn = restaurantSelection.querySelector(\".restaurant-selection__btn\");\n                    var box = restaurantSelection.querySelector(\".restaurant-selection__box\");\n                    var value = restaurantSelection.querySelector(\".restaurant-selection__value\");\n\n                    // toggle header selection\n                    if (e.target.matches(\".restaurant-selection__btn, .restaurant-selection__btn *\")) {\n                        btn.classList.toggle(\"restaurant-selection__btn--open\");\n                        box.classList.toggle(\"restaurant-selection__box--open\");\n                    }\n\n                    // display selected value\n                    else if (e.target.matches(\".restaurant-selection__restaurant, .restaurant-selection__restaurant *\")) {\n                            var restaurant = e.target.textContent;\n                            value.textContent = restaurant;\n\n                            btn.classList.toggle(\"restaurant-selection__btn--open\");\n                            box.classList.toggle(\"restaurant-selection__box--open\");\n                        }\n                });\n            } catch (err) {\n                (0, _base.handleError)(err);\n            }\n        }\n    }]);\n\n    return RestaurantSelectionComponent;\n}();\n\nexports.default = RestaurantSelectionComponent;\n\n//# sourceURL=webpack:///./src/components/restaurant-selection/index.js?");

/***/ }),

/***/ "./src/components/restaurant-selection/model.js":
/*!******************************************************!*\
  !*** ./src/components/restaurant-selection/model.js ***!
  \******************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _restaurant = __webpack_require__(/*! ../../core/entities/restaurant */ \"./src/core/entities/restaurant.js\");\n\nvar _restaurant2 = _interopRequireDefault(_restaurant);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar RestaurantSelectionModel = function () {\n    function RestaurantSelectionModel() {\n        _classCallCheck(this, RestaurantSelectionModel);\n\n        this.restaurants = this.getRestaurants();\n        this.selectedRestaurant = null;\n    }\n\n    _createClass(RestaurantSelectionModel, [{\n        key: \"getRestaurants\",\n        value: function getRestaurants() {\n            return [new _restaurant2.default(\"1\", \"McDonald's\"), new _restaurant2.default(\"2\", \"KFC\"), new _restaurant2.default(\"3\", \"Pizza Hut\"), new _restaurant2.default(\"4\", \"Burger King\"), new _restaurant2.default(\"5\", \"Cook Door\"), new _restaurant2.default(\"6\", \"Hardee's\"), new _restaurant2.default(\"7\", \"Papa John's\"), new _restaurant2.default(\"8\", \"Wendy's\"), new _restaurant2.default(\"9\", \"Domino's Pizza\"), new _restaurant2.default(\"10\", \"Dunkin' Donuts\"), new _restaurant2.default(\"11\", \"Subway\")];\n        }\n    }]);\n\n    return RestaurantSelectionModel;\n}();\n\nexports.default = RestaurantSelectionModel;\n\n//# sourceURL=webpack:///./src/components/restaurant-selection/model.js?");

/***/ }),

/***/ "./src/components/restaurant-selection/view.js":
/*!*****************************************************!*\
  !*** ./src/components/restaurant-selection/view.js ***!
  \*****************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Area = function Area(id, name) {\n    _classCallCheck(this, Area);\n\n    this.id = id;\n    this.name = name;\n};\n\nexports.default = Area;\n\n//# sourceURL=webpack:///./src/core/entities/area.js?");

/***/ }),

/***/ "./src/core/entities/city.js":
/*!***********************************!*\
  !*** ./src/core/entities/city.js ***!
  \***********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar City = function City(id, name, country, areas) {\n    _classCallCheck(this, City);\n\n    this.id = id;\n    this.name = name;\n    this.country = country;\n    this.areas = areas;\n};\n\nexports.default = City;\n\n//# sourceURL=webpack:///./src/core/entities/city.js?");

/***/ }),

/***/ "./src/core/entities/country.js":
/*!**************************************!*\
  !*** ./src/core/entities/country.js ***!
  \**************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Country = function Country(id, name) {\n    _classCallCheck(this, Country);\n\n    this.id = id;\n    this.name = name;\n};\n\nexports.default = Country;\n\n//# sourceURL=webpack:///./src/core/entities/country.js?");

/***/ }),

/***/ "./src/core/entities/menuCategory.js":
/*!*******************************************!*\
  !*** ./src/core/entities/menuCategory.js ***!
  \*******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar MenuCategory = function MenuCategory(id, name, menuItems) {\n    _classCallCheck(this, MenuCategory);\n\n    this.id = id;\n    this.name = name;\n    this.menuItems = menuItems;\n};\n\nexports.default = MenuCategory;\n\n//# sourceURL=webpack:///./src/core/entities/menuCategory.js?");

/***/ }),

/***/ "./src/core/entities/menuItem.js":
/*!***************************************!*\
  !*** ./src/core/entities/menuItem.js ***!
  \***************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar MenuItem = function MenuItem(id, name, image, price, desc) {\n    _classCallCheck(this, MenuItem);\n\n    this.id = id;\n    this.name = name;\n    this.image = image;\n    this.price = price;\n    this.desc = desc;\n};\n\nexports.default = MenuItem;\n\n//# sourceURL=webpack:///./src/core/entities/menuItem.js?");

/***/ }),

/***/ "./src/core/entities/restaurant.js":
/*!*****************************************!*\
  !*** ./src/core/entities/restaurant.js ***!
  \*****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Restaurant = function Restaurant(id, name, slogan, image, deliveryTime, tags) {\n    _classCallCheck(this, Restaurant);\n\n    this.id = id;\n    this.name = name;\n    this.slogan = slogan;\n    this.image = image;\n    this.deliveryTime = deliveryTime;\n    this.tags = tags;\n};\n\nexports.default = Restaurant;\n\n//# sourceURL=webpack:///./src/core/entities/restaurant.js?");

/***/ }),

/***/ "./src/core/entities/tag.js":
/*!**********************************!*\
  !*** ./src/core/entities/tag.js ***!
  \**********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Tag = function Tag(id, title) {\n    _classCallCheck(this, Tag);\n\n    this.id = id;\n    this.title = title;\n};\n\nexports.default = Tag;\n\n//# sourceURL=webpack:///./src/core/entities/tag.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _restaurant = __webpack_require__(/*! ../core/entities/restaurant */ \"./src/core/entities/restaurant.js\");\n\nvar _restaurant2 = _interopRequireDefault(_restaurant);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar HomePageModel = function () {\n    function HomePageModel() {\n        _classCallCheck(this, HomePageModel);\n\n        this.restaurants = this.getRestaurants();\n    }\n\n    _createClass(HomePageModel, [{\n        key: \"getRestaurants\",\n        value: function getRestaurants() {\n            return [new _restaurant2.default(\"1\", \"Wrap It\", \"Tasty and fresh food\", \"rest-01.jpg\", 30), new _restaurant2.default(\"2\", \"Wrap It\", \"Tasty and fresh food\", \"rest-02.jpg\", 30), new _restaurant2.default(\"3\", \"Wrap It\", \"Tasty and fresh food\", \"rest-03.jpg\", 30), new _restaurant2.default(\"4\", \"Wrap It\", \"Tasty and fresh food\", \"rest-04.jpg\", 30), new _restaurant2.default(\"5\", \"Wrap It\", \"Tasty and fresh food\", \"rest-05.jpg\", 30), new _restaurant2.default(\"6\", \"Wrap It\", \"Tasty and fresh food\", \"rest-06.jpg\", 30), new _restaurant2.default(\"7\", \"Wrap It\", \"Tasty and fresh food\", \"rest-07.jpg\", 30)];\n        }\n    }]);\n\n    return HomePageModel;\n}();\n\nexports.default = HomePageModel;\n\n//# sourceURL=webpack:///./src/home/model.js?");
...
"use strict";
eval("\n\nvar _index = __webpack_require__(/*! ./components/nav/index */ \"./src/components/nav/index.js\");\n\nvar _index2 = _interopRequireDefault(_index);\n\nvar _index3 = __webpack_require__(/*! ./components/footer/index */ \"./src/components/footer/index.js\");\n\nvar _index4 = _interopRequireDefault(_index3);\n\nvar _index5 = __webpack_require__(/*! ./components/menu-item-modal/index */ \"./src/components/menu-item-modal/index.js\");\n\nvar _index6 = _interopRequireDefault(_index5);\n\nvar _index7 = __webpack_require__(/*! ./components/cart/index */ \"./src/components/cart/index.js\");\n\nvar _index8 = _interopRequireDefault(_index7);\n\nvar _index9 = __webpack_require__(/*! ./components/location-selection/index */ \"./src/components/location-selection/index.js\");\n\nvar _index10 = _interopRequireDefault(_index9);\n\nvar _index11 = __webpack_require__(/*! ./components/restaurant-selection/index */ \"./src/components/restaurant-selection/index.js\");\n\nvar _index12 = _interopRequireDefault(_index11);\n\nvar _index13 = __webpack_require__(/*! ./home/index */ \"./src/home/index.js\");\n\nvar _index14 = _interopRequireDefault(_index13);\n\nvar _index15 = __webpack_require__(/*! ./restaurant-list/index */ \"./src/restaurant-list/index.js\");\n\nvar _index16 = _interopRequireDefault(_index15);\n\nvar _index17 = __webpack_require__(/*! ./restaurant-menu/index */ \"./src/restaurant-menu/index.js\");\n\nvar _index18 = _interopRequireDefault(_index17);\n\nvar _index19 = __webpack_require__(/*! ./checkout/index */ \"./src/checkout/index.js\");\n\nvar _index20 = _interopRequireDefault(_index19);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n// GLOBAL APP CONTROLLER\n\nvar navComponent = new _index2.default();\nvar footerComponent = new _index4.default();\nvar itemModalComponent = new _index6.default();\nvar cartComponent = new _index8.default();\nvar locationSelectionComponent = new _index10.default();\nvar restaurantSelectionComponent = new _index12.default();\n\nvar homePage = new _index14.default();\nvar restaurantListPage = new _index16.default();\nvar restaurantMenuPage = new _index18.default();\nvar checkoutPage = new _index20.default();\n\n//# sourceURL=webpack:///./src/index.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _base = __webpack_require__(/*! ../base */ \"./src/base.js\");\n\nvar _model = __webpack_require__(/*! ./model */ \"./src/restaurant-list/model.js\");\n\nvar _model2 = _interopRequireDefault(_model);\n\nvar _view = __webpack_require__(/*! ./view */ \"./src/restaurant-list/view.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar RestaurantListPage = function () {\n    function RestaurantListPage() {\n        _classCallCheck(this, RestaurantListPage);\n\n        this.setupEventListeners();\n    }\n\n    _createClass(RestaurantListPage, [{\n        key: \"init\",\n        value: function init() {\n            var _this = this;\n\n            try {\n                this.model = new _model2.default();\n                this.view = new _view.RestaurantListPageView();\n\n                this.model.restaurants.forEach(function (r) {\n                    return _this.view.renderRestaurantCard(r);\n                });\n                this.model.tags.forEach(function (t) {\n                    return _this.view.renderTag(t);\n                });\n            } catch (err) {\n                (0, _base.handleError)(err);\n            }\n        }\n    }, {\n        key: \"setupEventListeners\",\n        value: function setupEventListeners() {\n            try {\n\n                // initialize restaurants list\n                window.addEventListener(\"load\", this.init);\n\n                // toggle filter dropdown\n                _view.elements.filterDropdownHead.addEventListener(\"click\", function (e) {\n                    _view.elements.filterDropdown.classList.toggle(\"filter-dropdown--open\");\n                });\n\n                // get filter values \n                var filters = [];\n                _view.elements.filterCuisineList.addEventListener(\"change\", function (e) {\n\n                    // get selected item\n                    var filterItem = e.target.closest(\".filter-dropdown__cuisine-item\").children;\n                    var checkbox = filterItem[0];\n                    var label = filterItem[1];\n                    var value = label.textContent;\n                    // check if item value in filters list\n                    if (checkbox.checked) {\n                        if (filters.indexOf(value) < 0) {\n                            filters.push(value);\n                        }\n                    } else {\n                        if (filters.indexOf(value) >= 0) {\n                            var index = filters.indexOf(value);\n                            filters.splice(index, 1);\n                        }\n                    }\n                    // display count and clear label\n                    if (filters.length > 0) {\n                        _view.elements.filterCount.textContent = filters.length;\n                        _view.elements.filterCount.style.opacity = 1;\n                        _view.elements.filterCount.style.visibility = \"visible\";\n                        _view.elements.filterClear.style.display = \"inline-block\";\n                    } else {\n                        _view.elements.filterCount.style.opacity = 0;\n                        _view.elements.filterCount.style.visibility = \"hidden\";\n                        _view.elements.filterClear.style.display = \"none\";\n                    }\n                });\n\n                // clear filters\n                _view.elements.filterClear.addEventListener(\"click\", function (e) {\n                    filters = [];\n                    _view.elements.filterCount.style.opacity = 0;\n                    _view.elements.filterCount.style.visibility = \"hidden\";\n                    _view.elements.filterClear.style.display = \"none\";\n                });\n\n                // navigate to restaurant menu page\n                _view.elements.restaurantList.addEventListener(\"click\", function (e) {\n                    var restaurant = e.target.closest(\".restaurant-info-card\");\n                    var id = restaurant.dataset.id;\n                    window.location.assign(\"../restaurant-menu/index.html?id=\" + id);\n                });\n            } catch (err) {\n                console.log(err);\n            }\n        }\n    }]);\n\n    return RestaurantListPage;\n}();\n\nexports.default = RestaurantListPage;\n\n//# sourceURL=webpack:///./src/restaurant-list/index.js?");

/***/ }),

/***/ "./src/restaurant-list/model.js":
/*!**************************************!*\
  !*** ./src/restaurant-list/model.js ***!
  \**************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _restaurant = __webpack_require__(/*! ../core/entities/restaurant */ \"./src/core/entities/restaurant.js\");\n\nvar _restaurant2 = _interopRequireDefault(_restaurant);\n\nvar _tag = __webpack_require__(/*! ../core/entities/tag */ \"./src/core/entities/tag.js\");\n\nvar _tag2 = _interopRequireDefault(_tag);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar RestaurantListPageModel = function () {\n    function RestaurantListPageModel() {\n        _classCallCheck(this, RestaurantListPageModel);\n\n        this.restaurants = this.getRestaurants();\n        this.tags = this.getTags();\n    }\n\n    _createClass(RestaurantListPageModel, [{\n        key: \"getRestaurants\",\n        value: function getRestaurants() {\n\n            return [new _restaurant2.default(\"1\", \"Tea Time\", \"Any time, Tea time\", \"rest-01.jpg\", 30, [new _tag2.default(\"1\", \"Beverages\"), new _tag2.default(\"2\", \"Coffee\"), new _tag2.default(\"3\", \"Desserts\")]), new _restaurant2.default(\"2\", \"Tea Time\", \"Any time, Tea time\", \"rest-02.jpg\", 30, [new _tag2.default(\"1\", \"Beverages\"), new _tag2.default(\"2\", \"Coffee\"), new _tag2.default(\"3\", \"Desserts\")]), new _restaurant2.default(\"3\", \"Tea Time\", \"Any time, Tea time\", \"rest-03.jpg\", 30, [new _tag2.default(\"1\", \"Beverages\"), new _tag2.default(\"2\", \"Coffee\"), new _tag2.default(\"3\", \"Desserts\")]), new _restaurant2.default(\"4\", \"Tea Time\", \"Any time, Tea time\", \"rest-04.jpg\", 30, [new _tag2.default(\"1\", \"Beverages\"), new _tag2.default(\"2\", \"Coffee\"), new _tag2.default(\"3\", \"Desserts\")]), new _restaurant2.default(\"5\", \"Tea Time\", \"Any time, Tea time\", \"rest-05.jpg\", 30, [new _tag2.default(\"1\", \"Beverages\"), new _tag2.default(\"2\", \"Coffee\"), new _tag2.default(\"3\", \"Desserts\")]), new _restaurant2.default(\"6\", \"Tea Time\", \"Any time, Tea time\", \"rest-06.jpg\", 30, [new _tag2.default(\"1\", \"Beverages\"), new _tag2.default(\"2\", \"Coffee\"), new _tag2.default(\"3\", \"Desserts\")])];\n        }\n    }, {\n        key: \"getTags\",\n        value: function getTags() {\n            return [new _tag2.default(\"1\", \"Offers\"), new _tag2.default(\"2\", \"American\"), new _tag2.default(\"3\", \"Arabic\"), new _tag2.default(\"4\", \"Asian\"), new _tag2.default(\"5\", \"Bakery\"), new _tag2.default(\"6\", \"Beverages\"), new _tag2.default(\"7\", \"Burgers\"), new _tag2.default(\"8\", \"Coffee\"), new _tag2.default(\"9\", \"Desserts\"), new _tag2.default(\"10\", \"European\"), new _tag2.default(\"11\", \"Fast Food\"), new _tag2.default(\"12\", \"Healthy\"), new _tag2.default(\"13\", \"Indian\"), new _tag2.default(\"14\", \"Italian\"), new _tag2.default(\"15\", \"Latin\"), new _tag2.default(\"16\", \"Middle Eastern\"), new _tag2.default(\"17\", \"Pizza\"), new _tag2.default(\"18\", \"Salads\"), new _tag2.default(\"19\", \"Sandwiches\"), new _tag2.default(\"20\", \"Sea Food\"), new _tag2.default(\"21\", \"Turkish\"), new _tag2.default(\"22\", \"Vegan\")];\n        }\n    }]);\n\n    return RestaurantListPageModel;\n}();\n\nexports.default = RestaurantListPageModel;\n\n//# sourceURL=webpack:///./src/restaurant-list/model.js?");

/***/ }),

/***/ "./src/restaurant-list/view.js":
/*!*************************************!*\
  !*** ./src/restaurant-list/view.js ***!
  \*************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _menuCategory = __webpack_require__(/*! ../core/entities/menuCategory */ \"./src/core/entities/menuCategory.js\");\n\nvar _menuCategory2 = _interopRequireDefault(_menuCategory);\n\nvar _menuItem = __webpack_require__(/*! ../core/entities/menuItem */ \"./src/core/entities/menuItem.js\");\n\nvar _menuItem2 = _interopRequireDefault(_menuItem);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar RestaurantMenuPageModel = function () {\n    function RestaurantMenuPageModel() {\n        _classCallCheck(this, RestaurantMenuPageModel);\n\n        this.menuCategories = this.getMenuCategories();\n    }\n\n    _createClass(RestaurantMenuPageModel, [{\n        key: \"getMenuCategories\",\n        value: function getMenuCategories() {\n            return [new _menuCategory2.default(\"1\", \"Sandwiches\", this.getMenuItems()), new _menuCategory2.default(\"2\", \"Sides\", this.getMenuItems()), new _menuCategory2.default(\"3\", \"Beverages\", this.getMenuItems()), new _menuCategory2.default(\"4\", \"Salads\", this.getMenuItems()), new _menuCategory2.default(\"5\", \"Specialities\", this.getMenuItems())];\n        }\n    }, {\n        key: \"getMenuItems\",\n        value: function getMenuItems() {\n            return [new _menuItem2.default(\"1\", \"Double Cheese Burger\", \"photo-1549611016-3a70d82b5040.jpg\", 70, \"House-made turkey sausage, cage-free over medium egg, cheddar cheese, honey...\"), new _menuItem2.default(\"2\", \"Double Cheese Burger\", \"photo-1549611016-3a70d82b5040.jpg\", 70, \"House-made turkey sausage, cage-free over medium egg, cheddar cheese, honey...\")];\n        }\n    }]);\n\n    return RestaurantMenuPageModel;\n}();\n\nexports.default = RestaurantMenuPageModel;\n\n//# sourceURL=webpack:///./src/restaurant-menu/model.js?");
